...
digitalspaghetti.password = {	
	'defaults' : {
		...
		'minChar': 6,
		'minCharText': '',
		'colors': ["#bf3e3e", "#E8863F", "#f60", "#356529", "#356529"],
		'scores': [20, 30, 43, 50],
		'verdicts':	['Contraseña seguridad debil', 'Contraseña seguridad normal ', 'Contraseña seguridad mediana', 'Contraseña segura', 'Contraseña muy segura'],
		'raisePower': 1.4,
		'debug': false
	},
	'ruleScores' : {
